...
func (i *rockPi4) GetOptions(_ context.Context, extra rockPi4ExtraOptions) (overlay.Options, error) {
...
func (i *rockPi4) Install(_ context.Context, options overlay.InstallOptions[rockPi4ExtraOptions]) error {
