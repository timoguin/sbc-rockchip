...
func (i *rock5a) GetOptions(_ context.Context, extra rock5aExtraOptions) (overlay.Options, error) {
...
func (i *rock5a) Install(_ context.Context, options overlay.InstallOptions[rock5aExtraOptions]) error {
