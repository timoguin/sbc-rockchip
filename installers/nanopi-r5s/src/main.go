...
func (i *nanopir5s) GetOptions(_ context.Context, extra nanopir5sExtraOptions) (overlay.Options, error) {
...
func (i *nanopir5s) Install(_ context.Context, options overlay.InstallOptions[nanopir5sExtraOptions]) error {
