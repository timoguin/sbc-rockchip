...
func (i *helios64) GetOptions(_ context.Context, extra helios64ExtraOptions) (overlay.Options, error) {
...
func (i *helios64) Install(_ context.Context, options overlay.InstallOptions[helios64ExtraOptions]) error {
