...
func (i *rock64) GetOptions(_ context.Context, extra rock64ExtraOptions) (overlay.Options, error) {
...
func (i *rock64) Install(_ context.Context, options overlay.InstallOptions[rock64ExtraOptions]) error {
