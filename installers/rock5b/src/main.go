...
func (i *rock5b) GetOptions(_ context.Context, extra rock5bExtraOptions) (overlay.Options, error) {
	kernelArgs := []string{
		"cma=128MB",
		"console=tty0",
...
func (i *rock5b) Install(_ context.Context, options overlay.InstallOptions[rock5bExtraOptions]) error {
