...
func (i *rock4se) GetOptions(_ context.Context, extra rock4seExtraOptions) (overlay.Options, error) {
...
func (i *rock4se) Install(_ context.Context, options overlay.InstallOptions[rock4seExtraOptions]) error {
